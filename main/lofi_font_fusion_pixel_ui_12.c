 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --size 12 --bpp 1 --format lvgl --font assets/fonts/fusion-pixel-font/fusion-pixel-12px-proportional-ja.otf -r 0x20-0x7E --no-kerning --lv-include lvgl.h --lv-font-name lofi_font_fusion_pixel_ui_12 -o main/lofi_font_fusion_pixel_ui_12.c
 ******************************************************************************/
...
#ifndef LOFI_FONT_FUSION_PIXEL_UI_12
#define LOFI_FONT_FUSION_PIXEL_UI_12 1
#endif

#if LOFI_FONT_FUSION_PIXEL_UI_12
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lofi_font_fusion_pixel_ui_12 = {
#else
lv_font_t lofi_font_fusion_pixel_ui_12 = {
#endif
...
#endif /*#if LOFI_FONT_FUSION_PIXEL_UI_12*/
